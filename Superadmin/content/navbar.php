...
<!-- Sidebar - Brand -->
 ...
 <a class="sidebar-brand d-flex align-items-center justify-content-center mb-5 mt-5" href="#" id="nav-logo">
    <img class="rounded-circle " src="../images/wmsu-seal.png" alt="WMSU SEAL" width="80" height="80" />
    <div  class="sidebar-brand-text mx-3 text-white text-center fs-5 fw-bold">
    <span id="department" class="text-center text-white ml-2"><sup><b> WMSU</b></sup></span>
    </div>
  </a>
<!-- </a> -->
...
<!-- Colleges -->
<li class="nav-item">
  <a class="nav-link" href="superadmin-departments.php">
...
<!-- Courses -->
<li class="nav-item">
  <a class="nav-link" href="superadmin-courses.php">
    <i class="fas fa-building"></i>
    <span>Courses</span></a>
</li>
...
<!-- Admin Accounts -->
<li class="nav-item">
  <a class="nav-link" href="superadmin-admins.php">
