                    ...
                    <!-- notifications -->
						<li class="nav-item dropstart" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Notifications">
							<a class="nav-link dropstart active py-0" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								<i id="icons" class="fas fa-bell"></i><span class="badge rounded-pill bg-info text-white align-text-top" id="notif-number"><b class="text-white text-center">
									<?php	
										...
										$subg_num = mysqli_query($connection,"SELECT * FROM tblstudent_grades_sub");
										...
										$noticount =$notif_count+$subg_count+$subs_count;
										echo $noticount;

									?>	
								</b></span><span class="nav-label"> Notifications</span>
							</a>
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li>
									<a class="dropdown-item fas fa-user" href="adviser-student-request.php" ><span class="badge rounded-pill bg-danger text-white align-text-top" id="notif-number">
										<?php	
											echo $notif_count;		
										?>	
									</span> Account Request
									</a>
								</li>
								<li>
									<a class="dropdown-item fas fa-envelope-open-text" href="adviser-studentgrades-submissions.php" ><span class="badge rounded-pill bg-danger text-white align-text-top" id="notif-number">
										<?php		
											echo $subg_count;		
										?>
									</span> Grades Submission		
									</a>
								</li>
								<li>
									<a class="dropdown-item far fa-check-square fw-bold" href="adviser-subject-approval.php"><span class="badge rounded-pill bg-danger text-white align-text-top" id="notif-number">
										<?php	
											echo $subs_count;		
										?>
									</span> Subject Approval
									</a>
								</li>
							</ul>
						</li>
