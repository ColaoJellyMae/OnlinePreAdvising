                ...
                <div class="container">
                    <form class="row g-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="empID" value="emp3000">
                        </div>
                        
                        <!-- third line -->
                        <div class="col-md-12">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" id="email" value="delacruz@wmsu.edu.ph" required>
                        </div>
                        ...
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="Advised" value="BSCS1A" required>
                        </div>
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="input-name" aria-describedby="input-name-help" 
                                    value="Joseph Faith H. Brigole Jr."
                                readonly>
