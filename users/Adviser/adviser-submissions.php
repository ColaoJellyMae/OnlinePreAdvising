     ...
     <div class="container">
        <div class="row">
            <div class="col text-center">
                <a href="adviser-submissions.php" id="tab" class="btn btn-danger my-4 text-white fw-bold fs-2">Grades Submissions</a>
            </div>
            <div class="col text-center">
                <a href="adviser-subject-approval.php" id="tab" class="btn my-4 text-danger fw-bold text-center fs-2">Subject Approval</a>
            </div>
            <div class="w-100"></div>
        </div>
    </div>
    ...
    <div class="container p-2 container-fluid mb-3" >
        <div class="container overflow-auto" >
            <table class="table table-hover table-responsive table-striped table-bordered " id="table">
                ...
                <tbody>
                    <tr onclick="window.location='adviser-view-grades.php';" style=" cursor: pointer; "/>
                        <th scope="row">Brigole Jr., Joseph Faith H.</th>
                        <td>BSCS</td>
                        <td class="text text-primary">Pending Approval</td>
                    </tr>
                    <tr onclick="window.location='adviser-view-grades.php';" style=" cursor: pointer; "/>
