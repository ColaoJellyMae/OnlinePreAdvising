...
<body>
    ...
    <!-- CONTENT  -->
    <div class="container mt-5 mb-3 container-fluid">
        <div class="container">
            <p class="text text-danger text-center fw-bold fs-2"> Student's Name's <span class="text fw-normal">Desired Subjects</span></p>
        </div>
        <!-- left side -->
        <form action="adviser-subject-approval.php">
            <div class="row ">
                <div class="col">
                            ...
                            <tr>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input bg-danger border-0" type="checkbox" value="" id="flexCheckChecked" checked>
                    ...
                    <div class="contaier mt-3">
                        <center>
                            ...
                            <div class="container" id="buttons">
                                ...
                                <a href="adviser-subject-approval.php" class="btn btn-success border-0 text-white mb-2 p-1 mx-0 w-75 text-white">Load Subjects</a>
                                <input type="submit" class="btn btn-danger  border-0 mb-2 p-1 mx-0 w-75 text-white" value="Decline" />
