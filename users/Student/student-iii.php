	...
	<body>
        ...
        <center>
            <div class="contaier container-fluid mb-2" >
                <p class="text bg-light w-75 p-5" id="feedback">Subjects have been submitted, waiting for approval from your adviser <br><span><a class="text-danger fw-bold" href="student-disapprove.php">DEMO: DISAPPROVED</a> </span><br><span><a class="text-success fw-bold" href="student-approve.php">DEMO: APPROVED</a> </span> </p>
            </div>
        </center>
        <!-- FEEDBACK END -->
