	...
	<body>
        ...
        <center>
            <div class="contaier container-fluid" >
                <p class="text bg-light w-75 p-5" id="feedback">All set!<br>Your adviser approved your submission.<br><span><a href="student-schedule.php">Click here to view your schedule</a> </span> </p>
            </div>
        </center>
        <!-- FEEDBACK END -->
