	...
	<body>
		...
		<div class="container container-fluid" id="container-progress">
			...
			<div class="progress mx-auto" id="progressbar" style="height: 5px">
				<div class="progress-bar  " role="progressbar" id="progress1" style="width: 100%"></div>
            </div>
        ...
        <center>
            <div class="contaier container-fluid mb-2" >
                <p class="text bg-light w-75 p-5" id="feedback">Your submission was disapproved by your adviser. <br><span><a href="#" data-bs-toggle="modal" data-bs-target="#reason">Click here to check what's wrong</a> </span> and resubmit the requirements.</p>
            </div>
        </center>
        <!-- FEEDBACK END -->
        ...
        <div class="modal fade" id="reason" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="fw-bold mb-3">Adviser: <span class="fw-normal">REASON HERE...</span></p>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-sm btn-danger">Send</button>
                    </div>
                </div>
            </div>
        </div>
