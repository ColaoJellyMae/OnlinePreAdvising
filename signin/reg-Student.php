	...
	else
	{
	 	if (isset($_POST['add']))
		{
			...
			$student = "Student";
				...
				$sql="INSERT INTO tbluser (username,password,usertype,college)VALUES('$username','$password','$student','$department')";
        ...
        if (isset($_POST['add']))
		{
			...
			$sql_s="INSERT INTO tbluser_details (username,firstname,lastname,email,college,course,year,status)VALUES('$username','$firstname','$lastname','$email','$department','$course','$year','$status')";
